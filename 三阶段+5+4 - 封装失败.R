...
ThreePhrasesDependencyAlgorithm<-function(dim,wt1,wt2,wt3,method,source){
...
ThreePhrasesDependencyAlgorithm(7,0.01,0.01,0.01,'quantile','D:\\RST\\Gene100_1.csv' )
